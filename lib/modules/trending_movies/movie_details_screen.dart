...
class MovieDetailsScreen extends StatelessWidget {
 ...
 final TrendingMoviesResult trendingMoviesResult;
  ...
  MovieDetailsScreen({this.data, this.title,this.movieDetailModel,this.trendingMoviesResult});
  ...
  Widget build(BuildContext context) {
    return Builder(
        builder: (context) {
          ...
          AppCubit.get(context).getVideoByID(data.id);
                        ...
                        sliver: SliverList(
                          delegate: SliverChildListDelegate(
                            [
                              ...
                              Text(
                                '${data.overview}: ', style: TextStyle(color: Colors.white),
                              ),
                              SizedBox(height: 15,),
                              Row(
